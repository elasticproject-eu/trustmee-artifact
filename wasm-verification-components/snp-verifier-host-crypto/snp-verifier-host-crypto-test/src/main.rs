...
use host_crypto::{verify_snp_crypto_host, HostProcessorGeneration, HostVekKind};

wasmtime::component::bindgen!({
    path: "../snp-verifier-host-crypto-component/wit",
    world: "verifier",
});

#[derive(Parser, Debug)]
#[command(name = "snp-verifier-host-crypto-test")]
struct Args {
...
fn main() -> Result<()> {
    ...
    trustee::verifier::snp_host_crypto_interface::add_to_linker(&mut linker, |state| state)?;
