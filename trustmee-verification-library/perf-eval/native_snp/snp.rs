...
// Copied from:
// wasm-verification-components/snp-verifier/snp-verifier-component/src/snp.rs
// Native-specific behavior is provided by sibling `wasip2` and `waki` shims.
